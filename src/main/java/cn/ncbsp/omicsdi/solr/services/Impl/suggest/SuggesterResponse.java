 ...
 */
package cn.ncbsp.omicsdi.solr.services.Impl.suggest;
...
public class SuggesterResponse {
  ...
  public SuggesterResponse(NamedList<Object> suggestInfo) {
      SimpleOrderedMap suggestionsNode = (SimpleOrderedMap) suggestInfo;
      ...
      if (suggestionsNode != null) {
        ...
        suggestionsPerDictionary.put("suggestions", suggestionList);
      }
